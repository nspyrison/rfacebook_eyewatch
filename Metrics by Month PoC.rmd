...
token <- "EAACEdEose0cBADA5d0ZCTgRNbZAJWlxXImvlzAJqmxXhx3vghoQny8rOEO7CsJIYxRGZCFELDQiZAx9LLoQmZAmFGlX93Lp6E5aE1YDHZC6XQcESPCrV8lTKAdVX9M7wwE15h75pvxfAT36ZA67jvxSSjtZANOxdml0uLnuaE1ZCT1YXbrBz1ZC40Co3pdmi1kDdAZD" # temporary

pull_fb_posts(pages, n_ppp=1000, token = tmpToken) -> dataFileName
add_fb_reactions(myFileName, token = tmpToken) -> dataFileName
clean_fb_postreactions(dataFileName) 

### get filename:
#paste0("postreactions_clean_", gsub("-", "_", Sys.Date()))

### Dynamic filename
# a = "posts_raw_2018_06_03"
# class(parse(a))
# eval(parse(text=head(a)))
# 
# eval(parse(text="5+5"))
# a= "5+5"
# eval(parse(text=a))
# eval(parse(text=head(a)))
# eval(parse(text=cat("head(",a,")",sep="")))

ballarat_postreactions <- postreactions_clean_2018_07_02
